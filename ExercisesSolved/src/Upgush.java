//Task 1
//        Δίνεται το αρχείο Upgush.java το οποίο ορίζει την δημόσια κλάση
//        Upgush (Προσοχή! Δεν χρειάζεται να δημιουργηθεί το αρχείο, υπάρχει
//        ήδη στο δίσκο). H κλάση Upgush περιέχει τo ιδιωτικό πεδίο κλάσης
...
//        Για τη δημιουργία αντικειμένων της κλάσης Upgush διατίθενται δύο
